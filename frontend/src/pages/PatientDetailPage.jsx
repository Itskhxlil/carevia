...
export default function PatientDetailPage() {
  ...
  if (!patient) {
    return (
      <PageShell title="Patient not found" description="This record may have been removed or the ID is incorrect.">
        <Link to="/dashboard/patients" className="bg-surface-container-high hover:bg-surface-container-highest text-on-surface-variant hover:text-on-surface px-6 py-3 rounded-2xl text-sm font-bold transition-all flex items-center justify-center gap-2 w-max">
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-6 py-10 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 sm:p-8 rounded-3xl bg-surface/40 border border-outline-variant/30 shadow-xl relative overflow-hidden">
        {/* Accent glow */}
        ...
        <div className="flex items-center gap-6 relative z-10">
          ...
          <div className="min-w-0">
             ...
             <p className="text-base text-on-surface-variant font-medium truncate max-w-xl">
                {patient.diagnosis || "No primary diagnosis recorded"}
             </p>
             <p className="text-[10px] font-black text-outline uppercase tracking-widest mt-2 flex items-center gap-2">
                <span>Registry ID: {patient.id}</span>
                <span className="w-1 h-1 rounded-full bg-outline/30"></span>
                <span>Age: {patient.age}</span>
                <span className="w-1 h-1 rounded-full bg-outline/30"></span>
                <span className="text-primary">Last Encounter: {patient.lastVisit}</span>
             </p>
          </div>
        </div>

        <div className="flex items-center gap-3 relative z-10">
           <Link to="/dashboard/patients" className="w-12 h-12 rounded-2xl bg-surface-container-high/60 border border-outline-variant/30 flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:border-primary/50 transition-all shadow-sm" title="Back to Registry">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <section className="space-y-4">
             <div className="flex items-center justify-between mb-2 px-2">
                ...
                <button className="text-[10px] font-bold text-primary/70 hover:text-primary uppercase tracking-widest transition-colors flex items-center gap-1">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                <div className="p-5 rounded-2xl bg-surface/60 border border-outline-variant/30 shadow-sm group hover:border-primary/30 transition-all">
                   <div className="flex items-center gap-2 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                         <span className="material-symbols-outlined text-primary text-[18px]">favorite</span>
                      </div>
                      <span className="text-[10px] font-black text-outline uppercase tracking-widest">Blood Pressure</span>
                   </div>
                   <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-black text-on-surface">128/84</span>
                ...
                <div className="p-5 rounded-2xl bg-surface/60 border border-outline-variant/30 shadow-sm group hover:border-rose-500/30 transition-all">
                   <div className="flex items-center gap-2 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-rose-500/10 flex items-center justify-center">
                         <span className="material-symbols-outlined text-rose-400 text-[18px]">water_drop</span>
                      </div>
                      <span className="text-[10px] font-black text-outline uppercase tracking-widest">Glucose Level</span>
                   </div>
                   <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-black text-rose-300">142</span>
                      <span className="text-xs font-bold text-outline">mg/dL</span>
                   </div>
                ...
                <div className="p-5 rounded-2xl bg-surface/60 border border-outline-variant/30 shadow-sm group hover:border-sky-500/30 transition-all">
                   <div className="flex items-center gap-2 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-sky-500/10 flex items-center justify-center">
                         <span className="material-symbols-outlined text-sky-400 text-[18px]">monitor_weight</span>
                      </div>
                      <span className="text-[10px] font-black text-outline uppercase tracking-widest">Weight Status</span>
                   </div>
                   <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-black text-on-surface">78.5</span>
                      <span className="text-xs font-bold text-outline">kg</span>
                   </div>
                   <p className="mt-3 text-[10px] font-bold text-outline">-1.2kg since last visit</p>
                </div>
             </div>
          </section>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <MedicalCard title="Clinical Summary" icon="info" accent="primary">
            <div className="bg-surface-container-low/40 rounded-xl p-4 space-y-1">
              ...
              <div className="pt-4">
                 <p className="text-[10px] font-black text-outline uppercase tracking-widest mb-1.5">Diagnosis Archive</p>
                 <p className="text-sm text-on-surface-variant leading-relaxed italic border-l-2 border-primary/30 pl-3 py-1">
          ...
          {/* Follow-up Section */}
          <div className="bg-surface/40 rounded-2xl p-6 sm:p-8 border border-outline-variant/30">
            ...
            <form onSubmit={handleAddFollowUp} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label htmlFor="fu-date" className="text-[10px] font-black text-outline uppercase tracking-widest ml-1">
                  Encounter Date
                </label>
                <input
                  id="fu-date"
                  ...
                  className="w-full bg-surface-container-low/60 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none transition-all"
                />
              </div>
              <div className="space-y-1.5">
                <label htmlFor="fu-note" className="text-[10px] font-black text-outline uppercase tracking-widest ml-1">
                ...
                <textarea
                  ...
                  className="w-full bg-surface-container-low/60 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none transition-all resize-none min-h-[5rem]"
                />
              </div>
               ...
               <div className="space-y-4">
                  {followUps.map((fu, idx) => (
                    ...
                    >
                      ...
                      {/* Node */}
                      <div className="absolute left-0 top-[6px] w-[16px] h-[16px] rounded-full border-2 border-primary/40 bg-background shadow-[0_0_8px_rgba(var(--color-primary),0.2)]"></div>
                      
                      <div className="p-4 rounded-2xl bg-surface/40 border border-outline-variant/30 hover:bg-surface/60 transition-colors">
